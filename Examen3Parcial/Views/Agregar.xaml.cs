...
public partial class Agregar : ContentPage
{
    ...
    void fechahora()
    {
        ...
        {
            resultLabel.Text = "La fecha y hora seleccionada no puede ser menor a la actual.";
        ...
        else
        {
			...
			resultLabel.Text = "La fecha y hora seleccionada es valida";
		}
    }
    ...
    async void agregar()
    {
        ...
        await DisplayAlert("Listo", "Nota creada", "OK");
